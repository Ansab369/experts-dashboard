            ...
            <div className="ComponentA">
                <div className="Container" >
                    ...
                    <div className="container-button" >
                        <button className="button" onClick={submitPhoneNumber}>SignIn</button>
                    </div></>
                    :
                    <> <div className="Login-Container-Text179">
                        <p className="number-2" >Enter the 6 Digit OTP sent to </p>
                    ...
                    <div className="container-button" >
                        <button className="button" onClick={submitPhoneNumber}>Verify OTP</button>
                    </div></>
                }
                </div>
            </div>
